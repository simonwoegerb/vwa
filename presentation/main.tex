...
\institute[Brucknergymnasium Wels]{
	...
	4600 Wels}
\date{16. April 2024}
\titlegraphic{\includegraphics[scale=0.2]{brg_logo_2} \hspace*{.65\textwidth}\includegraphics[scale=0.2]{brg_logo_2}} 
% TITLE END
% MISC STUFF
\makeatletter
...
}{Gradl, P; Tinker, D; Park, A; Mireles, O;  Garcia, M; Wilkerson, R; Mckinney, C. Robust Metal Additive Manufacturing Process Selection and Development for Aerospace Components. Journal of Materials Engineering and Performance, 2022, 31, 10.1007/s11665-022-06850-0. }
	\end{centering}
\end{figure}
\end{frame}
...
%	\includegraphics[height=.74\textheight]{lattice_inside.png}
		\includegraphics[height=.74\textheight]{lattice_inside_2.jpg}
